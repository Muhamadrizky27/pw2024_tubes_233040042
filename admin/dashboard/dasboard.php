...
<body>
   ...
   <div class="container mt-5">
        ...
        <select id="sortSelect" onchange="fetchData()">
                ...
                <option value="nama_asc" <?php echo (isset($_GET['sort']) && $_GET['sort'] == 'nama_asc') ? 'selected' : ''; ?>>Nama Terkecil</option>
             <option value="nama_desc" <?php echo (isset($_GET['sort']) && $_GET['sort'] == 'nama_desc') ? 'selected' : ''; ?>>Nama Terbesar</option>
            </select>
            <table class="table">
    ...
    <div class="container-fluid container-sm">
        ...
        <form method="POST" enctype="multipart/form-data" action="tambah.php">
            ...
            <label class="form-label" for="admin_id">Admin</label>
            <input class="form-control" type="number" id="admin_id" name="admin_id" required><br><br>
